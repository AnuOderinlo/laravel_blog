    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.index') }}">
                ...
                <div class="sidebar-brand-text mx-3"><i class="text-danger font-strong">Bloganything.ng</i></div>
            </a>
            ...
            <x-admin.sidebar.post-links></x-admin.sidebar.post-links>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <x-admin.top-navbar.top-navbar></x-admin.top-navbar.top-navbar>
                <!-- End of Topbar -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Bloganything.ng {{ date("Y") }}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
